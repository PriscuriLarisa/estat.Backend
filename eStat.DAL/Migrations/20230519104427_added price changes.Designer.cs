...
namespace eStat.DAL.Migrations
{
    ...
    [Migration("20230519104427_added price changes")]
    partial class addedpricechanges
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("eStat.DAL.Entities.PriceChange", b =>
                {
                    ...
                    b.Property<Guid?>("UserProductGUID1")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("PriceChangeGUID");

                    b.HasIndex("ProductGUID1");

                    b.HasIndex("UserProductGUID1");
            ...
            modelBuilder.Entity("eStat.DAL.Entities.PriceChange", b =>
                {
                    b.HasOne("eStat.DAL.Entities.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductGUID1");

                    b.HasOne("eStat.DAL.Entities.UserProduct", "UserProduct")
                        .WithMany()
                        .HasForeignKey("UserProductGUID1");
